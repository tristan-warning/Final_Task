...
public:
    ...
    virtual int getInput() = 0; // declare a pure virtual function for getting user input
};
...
public:
    ...
    int getInput(); // override the getInput() function to get input from the console
};
